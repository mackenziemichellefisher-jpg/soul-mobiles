        ...
        <div className="flex-1 flex flex-col items-center justify-center p-4 pt-20">
          <div className="text-center text-white max-w-md w-full">
            ...
            <button
              ...
              className="w-full py-4 px-6 rounded-xl text-lg font-semibold bg-gradient-to-r from-purple-500/80 to-pink-500/80 text-white shadow-lg shadow-purple-500/30 hover:shadow-purple-500/50 hover:scale-105 transition-all duration-300"
            >
              Send Gift into the Void
            </button>
